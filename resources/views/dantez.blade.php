                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>@fat</td>
                                                        <td>pdf ler</td>
                                                        <td><a href="#!" class="label theme-bg2 text-white f-12">Reddet</a><a href="acıklama3" class="label theme-bg text-white f-12">Onayla</a><a href="#!" class="label theme-bg text-white f-12">Açıklama Yap</a></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
